...
<br>
  @if ($umkm->foto != null)
  <img class="mt-3" src="{{ asset('storage/' . $umkm->foto->photo_name) }}" alt="" style="justify-content: center">
  @else
  <img class="mt-3" src="http://source.unsplash.com/300x200?company" alt="" style="justify-content: center">
  @endif
  <button class="btn btn-primary ms-5 editProfile" id="modalEditUmkm" data-bs-toggle="modal" data-id="{{ auth()->user()->id }}" data-bs-target="#exampleModalUmkm">Edit Profile</button>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="/dashboard/update" method="post" enctype="multipart/form-data">
            @method('put')
            @csrf
            <input type="hidden" class="form-control" id="id_umkm" name="id_umkm" value="{{ $umkms->id }}" >
            <input type="text" class="form-control" id="photo_id" name="photo_id" value="{{ $umkm->photo_id }}" hidden>
            <input type="text" class="form-control" id="role" name="role" value="{{ $umkm->role }}" hidden>
            <div class="modal-body">
                <div class="">
                ...
                <div>
                  ...
                  <input class="form-control @error('photo_name') is-invalid @enderror" type="file" id="photo_name" name="photo_name"
