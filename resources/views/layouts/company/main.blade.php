                    ...
                    <div class="d-flex">
                        ...
                        <div class="col-10 ms-5">
                            ...
                            <div class="d-flex me-5">
                                ...
                                <p class="ms-2 text-muted">{{ $umkm->address }}</p>
                            </div>
                            <div class="d-flex mt-4">
                                <div class="col-auto">
                                    <h6>Website</h6>
                                    <h6 class="text-muted">{{ $umkm->website }}</h6>
                                </div>
                                <span class="border-end col-auto ms-4 me-4"></span>
                                <div class="col-auto">
                                    <h6>Sektor Bisnis</h6>
                                    <h6 class="text-muted">{{ $umkm->business_sector }}</h6>
                                </div>

                                <span class="border-end col-auto ms-4 me-4"></span>
                                <div class="col-auto">
                                    <h6>Alamat Email</h6>
                                    <h6 class="text-muted">{{ $umkm->email }}</h6>
                                </div>

                                <span class="border-end col-auto ms-4 me-4"></span>
                                <div class="col-auto">
                                    <h6>Nomor Telepon</h6>
                                    <h6 class="text-muted">{{ $umkm->telp }}</h6>
                                </div>
                            </div>
                        </div>
                    </div>
